...
def register_command_completions(
    command: str, subcommands: List[str] = None, args_completer: Callable = None
):
    """
...
def get_command_completions(partial_cmd: str) -> List[str]:
    ...
    return [cmd for cmd in _COMMAND_COMPLETIONS.keys() if cmd.startswith(partial_cmd)]
