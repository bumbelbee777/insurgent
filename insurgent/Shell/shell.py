...
class Shell:
    ...
    def __init__(self, config_file: Optional[str] = None, history_file: Optional[str] = None):
        """
    ...
    def run(self):
        ...
        print(f"Type {CYAN}help{RESET} for available commands, {CYAN}exit{RESET} to quit.")
        print()
